...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    /* TIM1_CH4 Init */
    hdma_tim1_ch4.Instance = DMA1_Channel6;
    ...
    if (HAL_DMA_ConfigChannelAttributes(&hdma_tim1_ch4, DMA_CHANNEL_NPRIV) != HAL_OK)
    {
      Error_Handler();
    }
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    /* TIM2 DMA Init */
    /* TIM2_CH1 Init */
    hdma_tim2_ch1.Instance = DMA1_Channel7;
  ...
  /* USER CODE END TIM4_MspInit 0 */
    ...
    PD15     ------> TIM4_CH4
    */
    GPIO_InitStruct.Pin = PPM_IN2_Pin|PPM_IN3_Pin|GPIO_PIN_15;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PB11     ------> TIM2_CH4
    */
    GPIO_InitStruct.Pin = DSHOT5_Pin|GPIO_PIN_1|GPIO_PIN_2;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM4_MspPostInit 0 */
    ...
    PD12     ------> TIM4_CH1
    */
    GPIO_InitStruct.Pin = PPM_IN1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM4;
    HAL_GPIO_Init(PPM_IN1_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD15     ------> TIM4_CH4
    */
    HAL_GPIO_DeInit(GPIOD, PPM_IN1_Pin|PPM_IN2_Pin|PPM_IN3_Pin|GPIO_PIN_15);
