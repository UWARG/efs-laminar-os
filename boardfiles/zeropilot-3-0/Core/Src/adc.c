...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA7     ------> ADC1_IN12
    */
    HAL_GPIO_DeInit(VBAT_B_SENSE_GPIO_Port, VBAT_B_SENSE_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB1     ------> ADC2_IN16
    */
    HAL_GPIO_DeInit(PWR_SENSE_GPIO_Port, PWR_SENSE_Pin);

    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_0|VBAT_A_SENSE_Pin);
